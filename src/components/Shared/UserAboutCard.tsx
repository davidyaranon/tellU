import {
  ...
  IonNote, IonIcon, IonChip, IonItem, IonContent, IonPopover, IonCardTitle, IonBadge
} from "@ionic/react";
import { useToast } from "@agney/ir-toast";
import { logoInstagram, logoSnapchat, logoTiktok, moon } from "ionicons/icons";
...
import testAch from '../../images/music.png';
            ...
            {busy ? (
              ...
              <>
                {/* <div className="badge-icon-container">
                  <img aria-hidden="true" id='trigger-click' style={{ width: "25px", height: "25px" }} src={testAch} className="badge-icon" />
                  <IonPopover style={context.darkMode ? { '--backdrop-opacity': '0.33', '--background': 'black' } : { '--backdrop-opacity': '0.33', '--background': 'white' }} trigger={"trigger-click"} triggerAction="click">
                    <IonContent style={context.darkMode ? { '--background': '#000000' } : { '--background': '#FFFFFF' }} scrollY={false} class="ion-padding">
                      <IonCardTitle style={{ fontSize: "1em" }}><u>{"TEST"}</u></IonCardTitle><div style={{ height: "5px" }} />{"TEST"}
                    </IonContent>
                  </IonPopover>
                  <img aria-hidden="true" id='trigger-click' style={{ width: "25px", height: "25px" }} src={testAch} className="badge-icon" />
                  <IonPopover style={context.darkMode ? { '--backdrop-opacity': '0.33', '--background': 'black' } : { '--backdrop-opacity': '0.33', '--background': 'white' }} trigger={"trigger-click"} triggerAction="click">

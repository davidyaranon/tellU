import { IonButton, IonButtons, IonCard, IonCardContent, IonCardTitle, IonContent, IonHeader, IonIcon, IonTitle, IonToolbar } from "@ionic/react";
      ...
      <IonContent>
        ...
        <IonCard>
          <IonCardContent>
            ...
            <strong>Privacy Policy</strong> <p>
              Evan Wallace built the tellU app as
              a Free app. This SERVICE is provided by
              Evan Wallace at no cost and is intended for use as
              is.
            </p> <p>
              ...
              Privacy Policy, do not hesitate to contact me at ewallace0214@gmail.com.
        ...
        <IonCard mode='ios'>
          <IonCardContent>
            ...
            <strong>Terms &amp; Conditions</strong> <p>
              ...
              to it, still belong to Evan Wallace.
            </p> <p>
              Evan Wallace is committed to ensuring that the app is
              ...
              Evan Wallace will not take responsibility for. Certain
              functions of the app will require the app to have an active
              internet connection. The connection can be Wi-Fi or provided
              by your mobile network provider, but Evan Wallace
              ...
              Along the same lines, Evan Wallace cannot always take
              responsibility for the way you use the app i.e. You need to
              make sure that your device stays charged – if it runs out of
              battery and you can’t turn it on to avail the Service,
              Evan Wallace cannot accept responsibility.
            </p> <p>
              With respect to Evan Wallace’s responsibility for your
              use of the app, when you’re using the app, it’s important to
              bear in mind that although we endeavor to ensure that it is
              updated and correct at all times, we do rely on third parties
              to provide information to us so that we can make it available
              to you. Evan Wallace accepts no liability for any
              ...
              using the app. Evan Wallace does not promise that it
        ...
        <IonCard mode="ios">
          <IonCardContent>
            ...
            <p>If you've scrolled this far, hi I'm Evan! I created this app for university students just like me who want a place to be notified of nearby events and also for students who want a place to meet new people :)</p>
